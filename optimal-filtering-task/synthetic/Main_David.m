...
%% Graph Generation
node_count = 64;
[graph, signal] = Get_David_Graph(node_count, 'none');
% [graph, signal] = Get_David_Graph(node_count, 'zero-mean');
% [graph, signal] = Get_David_Graph(node_count, 'zero-one');
% [graph, signal] = Get_David_Graph(node_count, 'plus-minus-one');
