...
%% Graph Generation
node_count = 100;
[graph, signal] = Get_Community_Graph(node_count, 'none');
% [graph, signal] = Get_Community_Graph(node_count, 'zero-mean');
% [graph, signal] = Get_Community_Graph(node_count, 'zero-one');
% [graph, signal] = Get_Community_Graph(node_count, 'plus-minus-one');
