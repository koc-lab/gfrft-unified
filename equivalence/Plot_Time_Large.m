...
function Plot_Time(power_durations, hyper_durations, elogm_durations, ...
                   fractional_orders, strategy_index)
    power_vals = squeeze(power_durations(strategy_index, :, :));
    hyper_vals = squeeze(hyper_durations(strategy_index, :, :));
    elogm_vals = squeeze(elogm_durations(strategy_index, :, :));
